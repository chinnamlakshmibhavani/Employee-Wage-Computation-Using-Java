public class EmpWageComputation
{
    ...
    EmpWageComputation(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
    ...
    {
        EmpWageComputation dMart = new EmpWageComputation("DMart", 8, 20, 100);
        EmpWageComputation reliance = new EmpWageComputation("Reliance", 4, 30, 150);
